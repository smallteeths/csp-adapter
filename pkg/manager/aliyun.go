...
func NewALIYUN(a aliyun.Client, k k8s.Client, s metrics.Scraper) *ALIYUN {
	return &ALIYUN{
		aliyun:  a,
		k8s:     k,
		scraper: s,
...
func (m *ALIYUN) runComplianceCheck(ctx context.Context) error {
	...
	return m.updateAdapterOutput(ctx, currentCheckoutInfo.EntitledLicenses == requiredLicenses, configMessage, statusMessage)
}
